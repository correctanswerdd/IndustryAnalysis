...
def sentemb_forward_longformer(
        cls,
        encoder,
        input_ids=None,
        attention_mask=None,
...
class LongformerForCL(LongformerPreTrainedModel):
    _keys_to_ignore_on_load_missing = [r"position_ids"]
    ...
    def forward(self,
        ...
        if sent_emb:
            return sentemb_forward_longformer(self, self.longformer,
                                              input_ids=input_ids,
                                              attention_mask=attention_mask,
                                              token_type_ids=token_type_ids,
                                              position_ids=position_ids,
            ...
            return cl_forward_longformer(self, self.longformer,
                                         input_ids=input_ids,
                                         attention_mask=attention_mask,
                                         token_type_ids=token_type_ids,
                                         position_ids=position_ids,
